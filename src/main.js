(function () {
    ...
    Concordya.prototype = {
        ...
        showElement: function (ele, forceShow) {
            if (ele.hasClass('show') && !forceShow) {
    ...
    $(document).ready(function () {
        ...
        $(".android").on({
            ...
            mouseleave: function () {
                enableAutoSlide = $(".android").hasClass('show');
            }
        });
        ...
        $('#mobile-app').on('click', function () {
            $.fn.fullpage.moveTo(1, 1);
            web.showElement($('.qrcode-dialog'), true);
        });
        
        $('#section2-mobile-app').on('click', function () {
            $.fn.fullpage.moveTo(1, 1);
            web.showElement($('.qrcode-dialog'), true);
        });
